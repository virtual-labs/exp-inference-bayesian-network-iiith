...
export function connectEdge(nodeslist, id1, id2){
  jsPlumbInstance.connect({
    uuids: ["input:0:" + nodeslist[id1].id, "input:0:" + nodeslist[id2].id],
    paintStyle: { stroke: wireColours, strokeWidth: 2 },
    overlays: ["Arrow"],
  });
  let input = nodeslist[id1];
  input.isConnected = true;
  nodeslist[id2].addParent(input);
}
